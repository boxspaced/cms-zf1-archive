...
class App_Domain_BlockTemplate extends \Boxspaced\EntityManager\Entity\AbstractEntity
{
    ...
    /**
     * @param App_Domain_BlockType $forType
     * @return App_Domain_BlockTemplate
     */
    public function setForType(App_Domain_BlockType $forType)
    {
