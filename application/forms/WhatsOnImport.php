...
class App_Form_WhatsOnImport extends App_Form_Form
{
    ...
    {
        $this->setAction('/whats-on/import');
        $this->setMethod('post');
        ...
        $element = new ZendExt_Form_Element_Image('file');
