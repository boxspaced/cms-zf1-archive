...
$auth = $container['Auth'];
$acl = $container['Acl'];
$settings = $bootstrap->getResource('config')->settings;
...
function CheckAuthentication()
{
	...
	// forget to add session_start() at the top of this file.
        ...
        if ($auth->hasIdentity()) {
            ...
            return $acl->isAllowedMultiRoles($identity->roles, 'default:asset', 'index');
        }
        return false;
}
...
$config['LicenseName'] = $settings->editorLicenseName;
$config['LicenseKey'] = $settings->editorLicenseKey;
...
*/
$config['Images'] = Array(
		'maxWidth' => $settings->editorMaxImageWidth,
		'maxHeight' => $settings->editorMaxImageHeight,
		'quality' => 80);
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $settings->editorMaxDocSize,
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $settings->editorMaxImageSize,
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $settings->editorMaxMediaSize,
